...
public class SimpleTest {
    ...
    public static void main(String[] args) {
        ...
        SelectRequest complex = RequestBuilders.select("productMainstream_B")
                .query(field("validFrom").between(from, to))
                .jsonFacets()
                    .enabled(true)
                    .facet("example", JsonTermsFacet.builder()
                            .field("ksor")
                            .limit(100)
                            .facets(Map.of(
                                    "max_validFrom", JsonStatFacet.of(max("validFrom"))))
                            .build())
                    .done()
                .grouping()
                    .enabled(true)
        ...
        List<Ksor> ksors = complexRes.grouped()
                .groups()
                .get("ksor")
                .entries()
                .stream()
